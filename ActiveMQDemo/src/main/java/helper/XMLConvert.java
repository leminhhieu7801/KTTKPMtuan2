...
public class XMLConvert<T> {
	...
	private T type;
	public XMLConvert(T type) { this.type = type;
	}
	...
	public T xml2Object(String xml) throws Exception{
		...
		sv=(T) ms.unmarshal(new StringReader(xml)); return sv;
	}
	
	public String object2XML(T obj)throws Exception{
		JAXBContext ctx= JAXBContext.newInstance(type.getClass()); Marshaller ms=ctx.createMarshaller();
